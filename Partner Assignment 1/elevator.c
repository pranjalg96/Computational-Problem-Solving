...
void scenario_1()
{
	...
	printf("Average elevator time: %f seconds\n", avg_time);
	printf("Minimum elevator time: %d seconds\n", min_time);
	printf("Maximum elevator time: %d seconds\n", max_time);
	printf("Average passenger time: %f seconds\n", avg_time_per_pass_all);
}
...
void scenario_3()
{
	...
	printf("Number of iterations: %d\n", num_iterations);
	printf("Best Average elevator time: %f seconds\n", best_avg_time);
	printf("Best Minimum elevator time: %d seconds\n", best_min_time);
	printf("Best Maximum elevator time: %d seconds\n", best_max_time);
	printf("Best Average passenger time: %f seconds\n", best_avg_per_passenger);
